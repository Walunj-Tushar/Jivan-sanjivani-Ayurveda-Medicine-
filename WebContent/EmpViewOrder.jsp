		...
		<div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				 <li> <a href="EmpViewMedicine.jsp">Medicine <b class="caret"></b></a></li>
				  
				</li>
				<li><a href="EmpViewOrder.jsp">Order</a></li>
				<li><a href="EmpViewFeedback.jsp">Feedback</a></li>
		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Order Details</h2>
					</div>
...
String sql ="select * from ordermedicine where Status=1";
...
<td>
<%String s="1"; 
    if ( resultSet.getString("PaymentStatus").equals(s) ) { %> 
   	<font  color="Green">	<i class="fa fa-lock"></i>Delivered</font>
   		
   <% } else { %>
   	<font  color="red">	<i class="fa fa-unlock"></i>Pending</font>
    		 <% } %>
  </td>
<td><a href="EmpActiveOrder.jsp?id=<%=resultSet.getString("Id") %>"><u><font  color="green">Done</font></u></a><br>
        		 
<a href="EmpDectiveOrder.jsp?id=<%=resultSet.getString("Id") %>"><u><font  color="red">Pending</font></u></a>
</td> 
