...
<script type="text/javascript">
	...
	if(MedicineName=="" || MedicineName.length>15){
		...
		alert("Medicine Order successfully...!");
	}
		return true;
	}
					...
					<h4 class="h-light">Provide <span class="color">best quality healthcare</span> for you</h4>
						...
						<ul class="lead-list">
							...
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Only use friendly environment</strong><br />Wisi lobortis eos ex, per at movet delectus, qui no vocent deleniti</span></li>
									 ...
									 <%@  page  import="java.sql.*"  %>
			<%
      			String FirstName="",LastName="",Address="",Contact="",Email="",Id="", MedicineName="", CompanyName="", MedicineImage="", ManufactureDate="",ExpireDate="", Description="",Amount="";
			    Connection con=null;
      		try
        		{
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>VERIFY MEDICINE DETAILS </h3>
									</div>
									<div class="panel-body">

									<form role="form" class="lead" action="BuyMedicine" method="post" name="register" id="register" onsubmit="return User_Registration()">
													<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>First Name</label>
													<input type="text" name="FirstName" id="FirstName" placeholder="First Name" class="form-control input-md" required>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Last Name</label>
													<input type="text" name="LastName" id="LastName" placeholder="Last Name" class="form-control input-md" required>
												</div>
											</div>
										</div>
											<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-12">
												<div class="form-group">
													<label>Address</label>
													<textarea type="text" name="Address" id="Address"  placeholder="Address" class="form-control input-md" required></textarea>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="MedicineName" id="MedicineName" value="<%=MedicineName%>" placeholder="Medicine Name" class="form-control input-md" required>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Medicine Company Name</label>
													<input type="text" name="CompanyName" id="CompanyName" value="<%=CompanyName%>" placeholder="Medicine Company Name" class="form-control input-md" required>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
													...
													<input type="date" name="ManufactureDate" id="ManufactureDate" value="<%=ManufactureDate%>" placeholder="Manufacture Date" class="form-control input-md" required>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
													<label>Expire Date</label>
													<input type="date" name="ExpireDate" id="ExpireDate" value="<%=ExpireDate%>" placeholder="Contact" class="form-control input-md" required>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-xs-6 col-sm-12">
												<div class="form-group">
													<label>Amount</label>
													<input type="text" name="Amount" id="Amount" value="<%=Amount%>" placeholder="Amount" class="form-control input-md" required>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
												<button type="submit" value="Submit" class="btn btn-skin btn-block btn-lg">Buy</button></div>
											</div>
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
