		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h3 class="h-ultra">MEDICINE DETAILS</h3>
					</div>
...
<%=resultSet.getString("Amount") %></td>
 <td><button><a href="BuyMedicine.jsp?Id=<%=resultSet.getString("Id") %>" style="color:green;"><i class="fa fa-edit"></i> Order Now</a></button><br><br>
 </td>   		
</tr>
<%
