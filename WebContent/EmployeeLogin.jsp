					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>EMPLOYEE LOGIN  </h3>
									</div>
									<div class="panel-body">
									<form role="form" class="lead" action="EmpLogin" method="post" name="login" id="login" onsubmit="return User_Login()">
										<div class="row">
