		...
		<div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li><a href="AdminHome.jsp">Order<b class="caret"></b></a></li>
				...
				<table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
                    <tr>
                               ...
                               <th>Expire Date</th>
                               <th>Price</th>
                               <th>Order Status For Employee</th>
                               <th>Action</th>                   
...
String sql ="select * from ordermedicine";
...
<%String s="1"; %>
   <% if ( resultSet.getString("Status").equals(s) ) { %> 
   	<font  color="Green">	<i class="fa fa-unlock"></i>Allocated</font>
   		
   <% } else { %>
   	<font  color="red">	<i class="fa fa-unlock"></i>Pending</font>
    		 <% } %>
  </td>
<td><a href="ActiveOrder.jsp?id=<%=resultSet.getString("Id") %>"><u><font  color="green">Allocate</font></u></a><br>
        		 
<a href="DectiveOrder.jsp?id=<%=resultSet.getString("Id") %>"><u><font  color="red">Pending</font></u></a>
</td> 
