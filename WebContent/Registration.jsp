					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> REGISTRATION HERE </h3>
									</div>
									<div class="panel-body">
									<form role="form" class="lead" action="UserRegistration" method="post" name="register" id="register" onsubmit="return User_Registration()">
										<div class="row">
										...
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
													...
													<input type="password" name="ConfirmPassword" id="ConfirmPassword" placeholder="Confirm Password" class="form-control input-md">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
												<button type="submit" value="Submit" class="btn btn-skin btn-block btn-lg">Sign-Up</button></div>
											</div>
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
